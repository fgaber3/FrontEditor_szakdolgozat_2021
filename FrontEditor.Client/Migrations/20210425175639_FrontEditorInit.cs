...
{
    public partial class FrontEditorInit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "ae473fa8-3deb-4141-82c0-99cdf7eff85d", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { 2, "28991c1d-6a6f-43e9-811a-019f0fee7dbe", "User", "USER" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin", "admin@admin.hu", new DateTime(2021, 4, 25, 19, 56, 38, 662, DateTimeKind.Local).AddTicks(5092), "ADMIN@ADMIN.HU", "ADMIN", "AQAAAAEAACcQAAAAEMEjEWCwkzjKf/KpTCpXYdPO1oQRA/AzCotRYMKMc2R1QkiJ5DUEgKGle1IEWGrKYw==", null, new DateTime(2021, 4, 25, 19, 56, 38, 667, DateTimeKind.Local).AddTicks(1428), "", "admin" });
